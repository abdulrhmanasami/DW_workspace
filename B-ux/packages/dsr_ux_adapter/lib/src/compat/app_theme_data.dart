...
/// Legacy AppThemeData compatibility class
/// Provides the expected AppThemeData API for app/lib/** usage
class AppThemeData {
  AppThemeData._();

  static bool _registered = false;

  /// Get the theme data using Dw* tokens
  ...
  /// Register UX theme overrides (idempotent)
  static void registerUxOverrides() {
    if (_registered) return;

    // Register any UX-specific theme overrides here
