...
echo "📋 Generating UI routes map"

# Output JSON structure for routes
cat << 'EOF' > B-ui/reports/UI01_routes_map.json
{
  "ui_routes": {
    "legal": [
      {
    ...
    "dsr": [
      {
        ...
        "feature_gated": true,
        "gate_condition": "trackingEnabled"
      },
      {
        "route": "/settings/dsr/erasure",
...
echo "✅ UI routes map generated at B-ui/reports/UI01_routes_map.json"
